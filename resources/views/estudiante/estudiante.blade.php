            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nombre_estudiante" name="nombre_estudiante" required placeholder="Nombre">
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="correo" name="correo" required placeholder="Correo Institucional">
                    </div>

                    <div class="mb-3">
                        <label for="confirmar_contrasena" class="form-label">Confirmar Contraseña:</label>
                        <div class="input-group">
                            <input type="password" class="form-control" id="confirmar_contrasena" name="confirmar_contrasena" required placeholder="Confirmar contraseña">
                            <span class="input-group-text">
