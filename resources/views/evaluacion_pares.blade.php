    ...
    console.log("Botón evaluar presionado"); 
        ...
        $.ajax({
            ...
            let criteriosParametros = JSON.parse(res);
             ...
             // Aquí imprimimos los datos en la consola para verlos
    console.log("Criterios y parámetros recibidos:");
    ...
    $(document).ready(function(){
        ...
        $('#calificarBtnForm').on('click', function() {
            ...
            if (!allQuestionsAnswered || !valid ) {
                ...
                console.log("id estudiante a evaluar.-" + $("#id-estudiante-a-evaluar").val());
                //fin eliminar
