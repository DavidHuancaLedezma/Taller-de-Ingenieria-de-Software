...
<body>
    ...
    <button class="back_button" id="boton-home">Regreso al home <i class="fas fa-home"></i></button>
     <div class="image-container">
        <img src="https://media.istockphoto.com/id/1432111463/es/vector/servicio-de-empleo-agencia-de-contrataci%C3%B3n-abastecimiento-de-candidatos-entrevista-de.jpg?s=612x612&w=0&k=20&c=0UtHF2wOjfjCqb7oWcWxzJXbrsC3JFXeZ8b5bCNTs6w=">
    </div>
    <div class="content">
